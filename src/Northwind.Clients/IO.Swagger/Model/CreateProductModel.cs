...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateProductModel :  IEquatable<CreateProductModel>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateProductModel(string productName = default(string), string quantityPerUnit = default(string), decimal? unitPrice = default(decimal?), int? unitsInStock = default(int?), int? unitsOnOrder = default(int?), int? reorderLevel = default(int?), bool? discontinued = default(bool?), int? supplierID = default(int?), int? categoryID = default(int?))
        {
            // to ensure "productName" is required (not null)
            if (productName == null)
            {
                throw new InvalidDataException("productName is a required property for CreateProductModel and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("discontinued is a required property for CreateProductModel and cannot be null");
            }
            else
            {
